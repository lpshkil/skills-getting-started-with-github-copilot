...
activities = {
    ...
    "Soccer Club": {
        "description": "Casual and competitive soccer play, drills and scrimmages",
...
def unregister_from_activity(activity_name: str, email: str):
    ...
    # If student isn't signed up, return 404
